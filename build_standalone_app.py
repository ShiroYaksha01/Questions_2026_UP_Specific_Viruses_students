...
- Touch gestures (swipe left/right to change questions)
- Sticky thumb-friendly bottom navigation on mobile
  ...
  <style>
    ...
    * {{
    ...
    @media (max-width: 880px) {{
      ...
      /* Add extra padding to body so content isn't covered by bottom bar */
      main {{
...
<body>
  ...
  <main>
    ...
    <div class="content-grid">
      ...
      <section class="q-card" id="touchArea">
        ...
        <span class="swipe-hint">💡 Tip: Swipe left / right to navigate on mobile</span>
  ...
  <div class="mobile-bottom-bar">
    <button type="button" class="btn-nav btn-nav-outline" id="btnMobilePrev">← Prev</button>
    <button type="button" class="btn-nav" id="btnMobileNext">Next →</button>
  </div>
  ...
  <script>
    (function () {{
      ...
      function renderQuestion() {{
        ...
        if (el.btnMobilePrev) el.btnMobilePrev.disabled = isFirst;
        if (el.btnMobileNext) el.btnMobileNext.disabled = isLast;
      ...
      function setupSwipeGestures() {{
        ...
        document.addEventListener("touchend", (e) => {{
          ...
          // If horizontal swipe is prominent (> 50px) and greater than vertical scroll
      ...
      function setupListeners() {{
        ...
        if (el.btnMobilePrev) el.btnMobilePrev.addEventListener("click", goToPrev);
        if (el.btnMobileNext) el.btnMobileNext.addEventListener("click", goToNext);
